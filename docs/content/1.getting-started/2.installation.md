...
description: Installation & UnInstallation Guide For SkyPort on Linux, Windows, macOS, or WSL.
---
...
| -------- | ------- |
| ![Search Bar Terminal Admin](/terminal_admin.png)  | ![PowerShell Tab](/powershell_admin.png)  |
