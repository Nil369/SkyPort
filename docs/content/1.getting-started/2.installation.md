...
```bash [installer.sh]
curl -fsSL https://skyport.akashhalder.in/install.sh | sudo bash
skyport --version
...
irm https://skyport.akashhalder.in/install.ps1 | iex
skyport --version
...
curl -fsSL https://skyport.akashhalder.in/install.ps1 | powershell -Command -
skyport --version
