...
---
![Skyport Banner](https://ik.imagekit.io/AkashPortfolioAssets/skyport_assets/skyport_banner.png?updatedAt=1779030716727)
...
::code-tree{default-value="installer/install.sh"}
...
Read the <u>***[Production Setup 🔥](/deployment/production-setup)***</u> guide to configure:
